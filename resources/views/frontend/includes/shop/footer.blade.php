        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    ...
                    <ul>
                        <li>Address: {{ config('app.location') }}</li>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="footer__widget">
                    ...
                    <div class="footer__widget__social">
                        <a href="{{ config('app.facebook') }}" target="_blank"><i class="fab fa-facebook"></i></a>
                        <a href="{{ config('app.instagram') }}" target="_blank"><i class="fab fa-instagram"></i></a>
                        <a href="{{ config('app.x') }}" target="_blank"><i class="fab fa-twitter"></i></a>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer__copyright">
                    ...
                    <div class="footer__copyright__payment"><img src="{{ asset('img/shop/payment-item.png') }}"
                            alt=""></div>
                </div>
            </div>
        </div>
