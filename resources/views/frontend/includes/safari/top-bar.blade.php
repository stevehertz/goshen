    ...
    <div class="row gx-0 align-items-center">
        <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
            <div class="d-flex flex-wrap">
                ...
                <a href="tel:{{ config('app.phone') }}" class="text-muted small me-4"><i
                        class="fas fa-phone-alt text-primary me-2"></i>{{  config('app.phone')  }}</a>
                <a href="mailto:{{ config('app.email') }}" class="text-muted small me-0"><i
                        class="fas fa-envelope text-primary me-2"></i>{{ config('app.email') }}</a>
            </div>
        </div>
